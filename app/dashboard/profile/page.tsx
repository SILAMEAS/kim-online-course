...
import { profileUpdateSchema, ProfileUpdateFormData } from '@/lib/validations/schemas';
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6 border border-border">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-foreground/60 flex items-center gap-2 mt-1">
              ...
              Member since {formatDistanceToNow(new Date(currentUser.created_at), { addSuffix: true })}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t">
          <div>
            <p className="text-2xl font-bold">{currentUser.enrolled_courses.length}</p>
            <p className="text-sm text-foreground/60">Courses Enrolled</p>
          </div>
          <div>
            <p className="text-2xl font-bold">{currentUser.certificates.length}</p>
            <p className="text-sm text-foreground/60">Certificates</p>
          </div>
          <div>
            <p className="text-2xl font-bold">{Math.floor(currentUser.enrolled_courses.length * 8.5)}</p>
